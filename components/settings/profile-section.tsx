        ...
        <CardContent className="flex flex-col items-start gap-5 p-6 sm:flex-row sm:items-center">
          <div className="relative">
            <div
              ...
              style={{ background: "linear-gradient(135deg, #00e6b8, #22d3ee, #1656d6)" }}
            >
              {initials}
            </div>
            <button
              ...
              onClick={() => toast.info("Avatar uploads ship after the file-storage phase")}
            >
          ...
          <div className="flex-1">
            ...
            <p className="mt-0.5 text-xs text-muted-foreground">
              Gradient is generated from your initials. Upload a custom image any time.
            </p>
          </div>
        </CardContent>
      </Card>
